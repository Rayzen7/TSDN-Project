  ...
  return (
    <div className='flex lg:flex-row flex-col-reverse justify-center items-center font-Poppins gap-20 lg:gap-44 py-12'>
      <div className='flex flex-col gap-5'>
          ...
          <p className='lg:w-[800px] w-full text-justify lg:px-0 px-5 text-[18px]'>OpenCV adalah pustaka untuk pengolahan gambar yang memungkinkan deteksi dan analisis objek. Dalam scanner makanan, OpenCV digunakan untuk mengubah gambar menjadi format yang dapat dianalisis, seperti mendeteksi warna dominan dan bentuk makanan, membantu sistem mengenali jenis makanan seperti pisang atau apel berdasarkan fitur visual.</p>
      </div>
