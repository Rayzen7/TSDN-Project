  ...
  return (
    <div className='flex lg:flex-row flex-col-reverse justify-center items-center font-Poppins gap-20 lg:gap-44 py-12'>
      <div className='flex flex-col gap-5'>
          ...
          <p className='lg:w-[800px] w-full text-justify lg:px-0 px-5 text-[15px] lg:text-[18px] lg:pt-0 pt-6'>Retrofit adalah perpustakaan yang mudah dan cepat untuk mengambil dan mengunggah data melalui layanan web berbasis REST. Retrofit mengelola proses penerimaan, pengiriman, dan pembuatan permintaan dan respons HTTP.</p>
      </div>
